...
@section('content-app')
    ...
    <form action="{{ route('user.campaign.save') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
        {{ csrf_field()  }}
                                    ...
                                    <div class="form-group form-group-sm {{ $errors->has('campaign_short_blurb') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                                    <textarea name="campaign_short_blurb"
                                                              ...
                                                              id="short_blurb"
                                                              class="form-control"
                                                              rows="3">{{ old('campaign_short_blurb') }}</textarea>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group m-b">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('campaign_funding_goal')  }}"
                                                       class="form-control">
                                            </div>
                                            <p style="padding-top: 8px;">
                                    ...
                                    <div class="form-group form-group-sm{{ $errors->has('campaign_description') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <textarea name="campaign_description"
                                                      ...
                                                      class="summernote form-control" value="{{ old('campaign_description') }}"></textarea>
                                        </div>
                                    </div>
