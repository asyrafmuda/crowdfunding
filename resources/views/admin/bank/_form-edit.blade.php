...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row">
        ...
        <form action="{{ route('admin.bank.update', [$bank->id, $bank->bank_code]) }}" class="form-horizontal" enctype="multipart/form-data" method="POST">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div>
                                <img src="{{ asset('storage/' . $bank->picture) }}" class="img-responsive" alt="">
                            </div>
                        </div>
                    </div>
                </div>
