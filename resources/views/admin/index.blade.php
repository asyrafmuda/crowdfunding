            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="row m-t-xs">
                        <div class="col-xs-6">
                            <h5 class="m-b-xs">Total Campaigns</h5>
                            <h1 class="no-margins">
                                {{ $campaigns->count() }}
                            </h1>
                        ...
                        <div class="col-xs-6">
                            <h5 class="m-b-xs">Total Users</h5>
                            <h1 class="no-margins">
                                {{ $users->count() }}
                            </h1>
                            <div class="font-bold text-navy">98% <i class="fa fa-bolt"></i></div>
                    ...
                    <table class="table small m-t-sm">
                        ...
                        <tr>
                            <td>
                                <strong>{{ $campaigns->all()->count() }}</strong> Campaigns

                            </td>
                            <td>
                                <strong>450</strong> Donator
                            </td>

                        </tr>
                        <tr>
                            <td>
                                <strong>400.000</strong> Verified Users
                            </td>
                            <td>
                                <strong>54</strong> Donation Success
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <strong>154</strong> Campaign Done
                            </td>
                            <td>
                                <strong>{{ $banks->count() }}</strong> Banks
                            </td>
                        </tr>
                        </tbody>
                    </table>
